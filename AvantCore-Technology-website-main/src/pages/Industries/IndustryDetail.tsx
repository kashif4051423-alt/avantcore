...
const industryDetails: Record<string, any> = {
  'banking': {
    ...
    stats: [
      { label: 'Financial Institutions Served', value: '200+' },
      { label: 'Compliance Projects', value: '500+' },
      { label: 'Cost Savings Achieved', value: '40%+' },
    ],
    layout: 'banking',
  },
  'retail': {
    ...
    stats: [
      { label: 'Retail Clients', value: '150+' },
  ...
  'healthcare': {
    ...
    stats: [
      { label: 'Healthcare Organizations', value: '100+' },
      { label: 'Patient Records Managed', value: '50M+' },
  ...
  'telecom': {
    ...
    stats: [
      { label: 'Telecom Partners', value: '80+' },
      { label: 'Network Upgrades', value: '1000+' },
      { label: 'Subscriber Growth', value: '25%+' },
    ],
    layout: 'default',
  },
  'public-sector': {
    ...
    stats: [
      { label: 'Government Agencies', value: '120+' },
  ...
  'energy': {
    ...
    stats: [
      { label: 'Energy Companies', value: '90+' },
      { label: 'Smart Meters Deployed', value: '100M+' },
